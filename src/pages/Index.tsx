      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <FeatureCard
            ...
            description="Automatically filters harmful messages and notifies you of potential threats while maintaining your privacy."
          />
          <FeatureCard
          ...
          <FeatureCard
            ...
            description="Access to professional support services and communities that understand what you're going through."
          />
          <FeatureCard
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-lg">
            <p className="text-gray-600 leading-relaxed">
              Inspired by Aaron's personal experience with cyberbullying at age 14, Descryber was born from the need to protect young people online. When Aaron received threatening messages including images of his house, he felt helpless when the evidence was deleted before authorities could act. This experience drove us to create a solution that ensures no one else has to go through the same ordeal.
            </p>
          </div>
        </div>
      </section>
